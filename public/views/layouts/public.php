...
<main class="flex-grow container mx-auto px-6 py-12">
    <header class="text-center py-16 border-b-2 border-sepia-900/20">
        ...
        <a href="/book" class="inline-block bg-[#2c2420] text-[#f4eee0] px-10 py-4 text-lg font-bold tracking-widest uppercase hover:bg-opacity-90 transition shadow-xl vintage-border">
            Direct Reserveren
        </a>
    </header>
